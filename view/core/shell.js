...
function renderBottomNav(role) {
  const tabs = {
    ...
    playground: [{ id: 'tickets', icon: 'fa-ticket', label: 'Tiket' }, { id: 'create', icon: 'fa-plus-circle', label: 'Buat' }, { id: 'report', icon: 'fa-chart-bar', label: 'Laporan' }, { id: 'stock', icon: 'fa-warehouse', label: 'Stok' }, { id: 'profile', icon: 'fa-user', label: 'Profil' }],
