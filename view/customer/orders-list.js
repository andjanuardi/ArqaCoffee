    ...
    <div class="space-y-3">
      ${myOrders
        ...
        <div class="order-card" onclick="showOrderDetail('${o.id}')">
          ...
          ${o.items.some(i => i.status === "rejected") && o.status !== "rejected" && o.reject_reason ? `<div class="mt-2 text-xs p-2 rounded" style="background:rgba(243,156,18,.1);color:var(--warning);border:1px solid rgba(243,156,18,.2)"><i class="fas fa-ban mr-1"></i><strong>Beberapa Item Ditolak:</strong> ${o.reject_reason}</div>` : ""}
