// ============================================================
        ...
        const DB = {
            ...
            menuItems: [
                { id: 'm1', name: 'Espresso', description: 'Kopi espresso murni dari biji Arabika pilihan', price: 18000, category: 'coffee', image: 'https://picsum.photos/seed/espresso42/400/300', is_available: true },
            ...
            orders: [
                {
                    id: 'o1', user_id: 'u6', table_id: 't3', order_type: 'dine-in', status: 'cooking', total_amount: 54000, payment_method: 'digital', payment_status: 'paid', delivery_address: '', created_at: '2025-01-15T08:30:00', items: [
                        { menu_item_id: 'm2', quantity: 1, unit_price: 28000, notes: '', status: 'cooking' },
                        { id: 'oi2', menu_item_id: 'm9', quantity: 1, unit_price: 35000, notes: 'pedas', status: 'cooking' }
                    ]
                },
                {
                    id: 'o2', user_id: 'u6', table_id: null, order_type: 'delivery', status: 'delivering', total_amount: 48000, payment_method: 'cod', payment_status: 'unpaid', delivery_address: 'Jl. Mawar No. 15, RT 03/RW 05', created_at: '2025-01-15T09:15:00', items: [
                ...
                {
                    id: 'o3', user_id: 'u6', table_id: 't6', order_type: 'dine-in', status: 'pending', total_amount: 22000, payment_method: '', payment_status: 'unpaid', delivery_address: '', created_at: '2025-01-15T10:00:00', items: [
            ...
            stockItems: [
                ...
                { id: 's6', name: 'Cokelat Bubuk', unit: 'kg', current_quantity: 4, min_quantity: 2, updated_at: '2025-01-13' },
            ...
            stockMovements: [
                ...
                { id: 'sm2', stock_item_id: 's2', user_id: 'u2', type: 'out', quantity: 3, notes: 'Pemakaian harian', created_at: '2025-01-15T08:00:00' },
            ...
            promos: [
                { id: 'p1', code: 'diskon20', title: 'Diskon 20% Kopi', icon: 'fa-percent', color: '#E07A3A', desc: 'Nikmati diskon 20% untuk semua minuman kopi setiap hari Senin.', terms: ['Berlaku setiap hari Senin','Maksimal 2 transaksi per pelanggan','Tidak dapat digabung dengan promo lain','Berlaku untuk Dine-In & Take Away'], is_active: true },
                { id: 'p2', code: 'bundleHemat', title: 'Beli 2 Gratis 1', icon: 'fa-box-open', color: '#1abc9c', desc: 'Beli 2 snack pilihan dan dapatkan 1 snack gratis!', terms: ['Berlaku untuk snack dengan harga sama/lebih rendah','Berlaku setiap hari','Gratis item dengan harga terendah','Stok terbatas'], is_active: true },
                { id: 'p3', code: 'happyHour', title: 'Happy Hour 30%', icon: 'fa-clock', color: '#6C5CE7', desc: 'Diskon 30% untuk semua menu di jam 14:00–17:00 setiap hari.', terms: ['Berlaku pukul 14:00–17:00','Berlaku untuk semua menu','Maksimal 3 item per transaksi','Berlaku Dine-In, Take Away & Delivery'], is_active: true }
            ],
            dailySales: [
