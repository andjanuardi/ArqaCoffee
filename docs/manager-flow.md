# Panduan Penggunaan Aplikasi ARQA Coffee — Untuk Manajer

---

## 1. Cara Masuk ke Aplikasi

Ada 2 cara untuk masuk ke aplikasi ARQA Coffee sebagai Manajer:

### 1.1 Masuk Cepat (Demo)

- Dari halaman awal, klik card bertuliskan **"Manajer"**
- Anda akan langsung masuk dan diarahkan ke halaman Dashboard
...
Sebagai Manajer, Anda memiliki **2 cara navigasi** untuk berpindah halaman:
...
Setelah masuk, Anda akan melihat halaman **Dashboard**. Ini adalah pusat informasi yang menampilkan ringkasan seluruh operasional kafe.
...
Klik salah satu meja untuk melihat detail dan pesanan di meja tersebut.

---

## 4. Kelola Pengguna

Halaman ini menampilkan daftar semua pengguna aplikasi kecuali **Admin** (akun admin tidak bisa dilihat atau diubah oleh Manajer).
...
> **⚠️ Perhatian:** Anda **tidak bisa** mengubah role seseorang menjadi **Admin**. Juga tidak bisa mengedit atau menghapus akun admin.
...
2. Isi data berikut:
   - Nama Lengkap
   - Email (harus unik, belum dipakai)
   - Password
   - Nomor Telepon
   - Role (jabatan)
3. Klik **"Simpan"**
...
> **💡 Stok menipis:** Jika stok mencapai batas minimal, akan muncul animasi kedip merah dan notifikasi dikirim ke Manajer & Admin.
...
- **Absen Masuk (Check-In):**
  1. Pastikan Anda **berada di dalam radius kafe** (200 meter)
  2. Peta akan menunjukkan lokasi Anda
  3. Klik **"Check In"**
  4. Status berubah menjadi **"Sedang Bekerja"**
- **Absen Pulang (Check-Out):**
  1. Jika sudah check-in, akan muncul kartu **"Sedang Bekerja"**
  2. Klik **"Check Out"**
  3. Lokasi Anda tersimpan otomatis
- **Keluar** — klik **"Keluar dari Akun"** untuk kembali ke halaman login

> **💡 Jika di luar radius kafe:** Check-in tidak bisa dilakukan. Akan muncul peringatan "Anda di luar radius kafe".
...
**Q: Kenapa saya tidak bisa menghapus akun Admin?**
A: Akun Admin hanya bisa dikelola oleh Admin itu sendiri. Manajer tidak memiliki akses ke data Admin.
...
**Q: Bagaimana cara melihat stok bahan?**
A: Buka **Stok Bahan** dari side drawer. Stok diurutkan dari yang paling menipis. Bahan dengan stok kritis akan berkedip merah.

**Q: Saya tidak bisa check-in, kenapa?**
A: Pastikan Anda berada dalam radius 200 meter dari kafe. Cek juga apakah GPS perangkat Anda sudah aktif.
...
**Q: Bagaimana cara melihat status terkini pesanan?**
...
A: Ya, buka **Kelola Pengguna**, klik **Edit** pada pengguna yang ingin diubah, lalu pilih role baru. Namun Anda **tidak bisa** mengubah role seseorang menjadi Admin.
