...
const DB = loadDB() || (function() { return {
  users: [
    { id: "u1", name: "Admin ARQA", email: "admin@arqa.coffee", password: "admin123", role: "admin", phone: "081234567890", avatar: "A", address: "" },
    { id: "u2", name: "Rina Manager", email: "manager@arqa.coffee", password: "manager123", role: "manager", phone: "081234567891", avatar: "R", address: "" },
    { id: "u3", name: "Dian Kasir", email: "kasir@arqa.coffee", password: "kasir123", role: "cashier", phone: "081234567892", avatar: "D", address: "" },
    { id: "u4", name: "Budi Dapur", email: "dapur@arqa.coffee", password: "dapur123", role: "kitchen", phone: "081234567893", avatar: "B", address: "" },
    { id: "u5", name: "Andi Kurir", email: "kurir@arqa.coffee", password: "kurir123", role: "courier", phone: "081234567894", avatar: "K", address: "" },
    { id: "u6", name: "Sari Pelanggan", email: "customer@arqa.coffee", password: "customer123", role: "customer", phone: "081234567895", avatar: "S", address: "" },
  ],
  tables: [
    { id: "t1", number: "1", qr_code: "ARQA-T1", status: "available", capacity: 2 },
    { id: "t2", number: "2", qr_code: "ARQA-T2", status: "available", capacity: 4 },
    { id: "t3", number: "3", qr_code: "ARQA-T3", status: "occupied", capacity: 4 },
    { id: "t4", number: "4", qr_code: "ARQA-T4", status: "available", capacity: 2 },
    { id: "t5", number: "5", qr_code: "ARQA-T5", status: "available", capacity: 6 },
    { id: "t6", number: "6", qr_code: "ARQA-T6", status: "occupied", capacity: 4 },
    { id: "t7", number: "7", qr_code: "ARQA-T7", status: "available", capacity: 2 },
    { id: "t8", number: "8", qr_code: "ARQA-T8", status: "available", capacity: 4 },
  ],
  menuItems: [
  ...
  attendances: [
    { id: "a1", user_id: "u3", check_in: "2025-01-15T07:55:00", check_out: null, lat: -6.9175, lng: 107.6191, status: "present" },
    { id: "a2", user_id: "u4", check_in: "2025-01-15T07:50:00", check_out: null, lat: -6.9175, lng: 107.6191, status: "present" },
    { id: "a3", user_id: "u5", check_in: "2025-01-15T08:00:00", check_out: null, lat: -6.9175, lng: 107.6191, status: "present" },
    { id: "a4", user_id: "u3", check_in: "2025-01-14T08:05:00", check_out: "2025-01-14T17:00:00", lat: -6.9175, lng: 107.6191, status: "present" },
    { id: "a5", user_id: "u4", check_in: "2025-01-14T07:58:00", check_out: "2025-01-14T17:05:00", lat: -6.9175, lng: 107.6191, status: "present" },
  ],
  courierTracking: [
  ...
  promos: [
    ...
    },
    {
      ...
      discount_type: "percent", discount_value: 33,
      start_date: "2025-01-01", end_date: "2025-12-31",
