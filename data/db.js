...
const DB =
  ...
  (function () {
    return {
      ...
      playgroundTickets: [
        { id: "pg_demo1", user_id: "u6", customer_name: "Budi Santoso", children: [{ name: "Andi" }, { name: "Rudi" }], companions: [], companion_count: 0, socks_per_child: [true, false], socks_total: 10000, items: [{ menu_item_id: "ps5", name: "Mie Cup", quantity: 2, unit_price: 7000 }], hours: 2, start_time: new Date(Date.now() - 3600000).toISOString(), end_time: new Date(Date.now() + 3600000).toISOString(), subtotal: 80000, items_total: 14000, total_amount: 104000, payment_status: "paid", payment_method: "qris", status: "active", created_at: new Date(Date.now() - 3600000).toISOString() },
