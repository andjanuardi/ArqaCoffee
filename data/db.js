      ...
      playgroundTickets: [
        {
          ...
          socks_per_child: [true, true],
          companions: [{ name: "Bu Sarah" }],
          companion_count: 1,
          has_socks: true,
          socks_total: 20000,
        ...
        },
        {
          ...
          socks_per_child: [true, true, true],
          companions: [{ name: "Bu Dewi" }, { name: "Mba Rini" }],
          companion_count: 2,
          has_socks: true,
          socks_total: 30000,
        ...
        },
        {
          ...
          children: [{ name: "Fajar" }],
          socks_per_child: [true],
          companions: [{ name: "Pak Rudi" }],
          companion_count: 1,
          has_socks: true,
          socks_total: 10000,
          items: [{ menu_item_id: "m13", name: "Brownies Lava", quantity: 1, unit_price: 26000 }],
          hours: 1,
          start_time: new Date(Date.now() - 200 * 60000).toISOString(),
          ...
          status: "completed",
          created_at: new Date(Date.now() - 205 * 60000).toISOString(),
        },
      ],
    };
  })();
